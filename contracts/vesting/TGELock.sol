...
contract TGELock is Ownable, ReentrancyGuard {
  ...
  uint256 constant public unlockPercent = 792;        // 792 = 7,92%
  uint256 constant public cliff = 6;
  ...
  uint256 constant public tokenPriceUSD = 90;         // 90 = 0,90$
